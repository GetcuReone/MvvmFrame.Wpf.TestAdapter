...
namespace InfrastructureTests
{
    ...
    public class InfrastructureTests : TestBase
    {
        ...
        public void NugetHaveNeedFilesTestCase()
        {
            Given("Get folder with .nupkg", () =>
            {
                ...
                .Then("Check archive .nupkg", fileNames =>
                {
                    ...
                    {
                        "lib/net472/MvvmFrame.Wpf.TestAdapter.dll",
                        "lib/net472/MvvmFrame.Wpf.TestAdapter.xml",
                        "LICENSE-2.0.txt"
                    };
        ...
        {
            string partNameAssemblies = "MvvmFrame.Wpf.TestAdapter";
